...
namespace eZx.Database
{
	partial class Form_ConstructDatabase : System.Windows.Forms.Form
	{
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent()
		{
            ...
            this.eZDataGridView1 = new eZDataGridView();
            ...
            this.ToolTip1.SetToolTip(this.Label1, "Excel数据库中除了第一列主键外，其余每一个字段所要满足的数据类型。");
            // 
            // Label2
            // 
            ...
            this.btnCheckAllFields.Click += new System.EventHandler(this.BtnCheckAllFieldsOnClick);
            // 
            // btnCancel
            // 
            ...
            this.Text = "构造数据库";
            this.Load += new System.EventHandler(this.Form_ConstructDatabase_Load);
		...
		internal eZDataGridView eZDataGridView1;
