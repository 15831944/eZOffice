...
namespace eZwd.AddinManager
{
    ...
    internal static class StringSerializer
    {
        ...
        /// <summary>
        /// 为了解决SerializationException，方法之一是确保此assembly放置在与aWord.exe 或 revit.exe相同的文件夹中，
        /// 另一个方法就是实现一个像这样的类。
        /// </summary>
        /// <remarks>
        ...
        /// One solution is to ensure that assembly resides in same directory as aWord.exe or revit.exe,
