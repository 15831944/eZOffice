...
namespace eZwd.AddinManager
{
    internal partial class form_AddinManager : Form
    {
        ...
        public static form_AddinManager GetUniqueForm(Application WordApp)
        {
            if (_uniqueForm == null)
            {
        ...
        private form_AddinManager()
        {
            ...
            //
            _nodesInfo = new Dictionary<AddinManagerAssembly, List<IWordExCommand>>(new AssemblyComparer());
            //
        }
        ...
        private Dictionary<AddinManagerAssembly, List<IWordExCommand>> _nodesInfo;

        /// <summary> 与 TreeView 同步的节点数据 </summary>
        internal Dictionary<AddinManagerAssembly, List<IWordExCommand>> NodesInfo
        {
            get
            {
                return _nodesInfo;
        ...
        internal void RefreshTreeView(Dictionary<AddinManagerAssembly, List<IWordExCommand>> nodesInfo)
        {
        ...
        private void AddMethodsInOneAssembly(string assemblyPath, List<IWordExCommand> methods)
        {
            ...
            if (methods.Any())
            {
                ...
                //
                List<IWordExCommand> mds = new List<IWordExCommand>();
        ...
        private void RemoveMethod(TreeNode ndAss)
        {
            ...
            IWordExCommand mtd = ndAss.Tag as IWordExCommand;
            //
        ...
        /// <summary> 通过选择文件对话框选择要进行数据提取的Word文件 </summary>
        /// <returns> 要进行数据提取的Word文件的绝对路径 </returns>
        ...
        {
            var exCommand = ndCommand.Tag as IWordExCommand;
            AddinManagerAssembly asm = ndCommand.Parent.Tag as AddinManagerAssembly;
            //
            string assemblyPath = asm.Path;
            ExCommandExecutor.InvokeExternalCommand(assemblyPath, exCommand, _WordApplication);
        }
        ...
        private void ShowExCommandDescription(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            {
                // 提取此方法所在的类的对应的描述
                var exCommand = nd.Tag as IWordExCommand;
