...
namespace eZwd.AddinManager
{
    ...
    {
        /// <summary> 将程序集文件加载到内存，并且提取出其中的 Word 外部命令 </summary>
        /// <param name="assemblyPath"></param>
        /// <returns></returns>
        public static List<IWordExCommand> RetriveExternalCommandsFromAssembly(string assemblyPath)
        {
            Assembly asm;
        ...
        private static List<IWordExCommand> GetExternalCommandClass(Assembly ass)
        {
            List<IWordExCommand> ecClasses = new List<IWordExCommand>();
            Type[] classes = null;
            ...
            if (classes != null)
            {
                ...
                {
                    if ((cls != null) && cls.GetInterfaces().Any(r => r == typeof (IWordExCommand)))
                        // 说明这个类实现了 Word 的命令接口
                    {
                        ...
                        if (m != null && m.IsPublic)
                        {
                            ...
                            IWordExCommand exC = ins as IWordExCommand;
