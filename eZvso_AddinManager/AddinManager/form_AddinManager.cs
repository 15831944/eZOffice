...
namespace eZvso.AddinManager
{
    ...
    {
        private static Application _VisioApplication;
        ...
        private form_AddinManager()
        {
            ...
            //
            _nodesInfo = new Dictionary<AddinManagerAssembly, List<IVisioExCommand>>(new AssemblyComparer());
            //
        }
        ...
        private Dictionary<AddinManagerAssembly, List<IVisioExCommand>> _nodesInfo;

        /// <summary> 与 TreeView 同步的节点数据 </summary>
        internal Dictionary<AddinManagerAssembly, List<IVisioExCommand>> NodesInfo
        {
            get
            {
                return _nodesInfo;
        ...
        internal void RefreshTreeView(Dictionary<AddinManagerAssembly, List<IVisioExCommand>> nodesInfo)
        {
        ...
        private void AddMethodsInOneAssembly(string assemblyPath, List<IVisioExCommand> methods)
        {
            ...
            if (methods.Any())
            {
                ...
                //
                List<IVisioExCommand> mds = new List<IVisioExCommand>();
        ...
        private void RemoveMethod(TreeNode ndAss)
        {
            ...
            IVisioExCommand mtd = ndAss.Tag as IVisioExCommand;
            //
        ...
        /// <summary> 通过选择文件对话框选择要进行数据提取的Visio文件 </summary>
        /// <returns> 要进行数据提取的Visio文件的绝对路径 </returns>
        ...
        {
            var exCommand = ndCommand.Tag as IVisioExCommand;
            AddinManagerAssembly asm = ndCommand.Parent.Tag as AddinManagerAssembly;
            //
            string assemblyPath = asm.Path;
            ExCommandExecutor.InvokeExternalCommand(assemblyPath, exCommand, _VisioApplication);
        }
        ...
        private void ShowExCommandDescription(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            {
                // 提取此方法所在的类的对应的描述
                var exCommand = nd.Tag as IVisioExCommand;
